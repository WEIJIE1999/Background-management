  ...
  <div>
    ...
    <el-card>
      ...
      :show-row-hover="false">
        ...
        <!--排序-->
        <template slot="isnum" slot-scope="scope">
          <el-tag size="mini" v-if="scope.row.cat_level ===0">一级标签</el-tag>
          <el-tag size="mini" type="success" v-else-if ="scope.row.cat_level ===1">二级标签</el-tag>
...
export default {
  ...
  methods: {
    ...
    // 选择器变化触发监听器
    parentsCateChanged () {
      // 如果selectedKeys 数组中的length大于0，证明选中了父级分类，反之，没有选中
